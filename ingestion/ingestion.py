...
import time
import sys
from usage import parse_log, is_get_request
...
print('Ingestion: Channel to RabbitMQ established')

# Read weblogs

f = open('weblogs.log', 'r')

print('Ingestion: File logs opened')
...
print('Ingestion: Publish of logs to RabbitMQ Done')
